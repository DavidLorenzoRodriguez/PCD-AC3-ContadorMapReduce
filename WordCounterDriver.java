...
public class WordCounterDriver extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
		...
		job.setMapperClass(WordCounterMapper.class); //indicar las clase que se encarga de los procesos map
		job.setReducerClass(WordCounterReducer.class); //indicar las clase que se encarga de los procesos reducer
